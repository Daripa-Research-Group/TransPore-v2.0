...
Daripa, P. & Rohit Mishra. (2023) Modeling shear thinning polymer flooding using a dynamic viscosity model,
Phys. Fluids, 2023; doi: 10.1063/5.0145061
...
## Refer to the user guide for detailed instructions on using the code for non-Newtonian polymer flooding
